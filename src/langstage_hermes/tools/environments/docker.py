...
* **Naming.** ``langstage-hermes-{session_id}`` truncated to 63 chars (Docker's
...
_CONTAINER_SNAP = "/tmp/langstage-hermes-snap.sh"
_CONTAINER_CWD = "/tmp/langstage-hermes-cwd.txt"
...
def _sanitize_container_name(session_id: str) -> str:
    ...
    Strategy:
      ...
      2. Prefix with ``langstage-hermes-``.
...
class DockerEnvironment(BaseEnvironment):
    ...
    def __init__(self, session_id: str) -> None:
        ...
        self._image = os.environ.get("LANGSTAGE_HERMES_DOCKER_IMAGE") or os.environ.get(
            "DEEPAGENT_HERMES_DOCKER_IMAGE", "python:3.13-slim"
        )
        workspace = os.environ.get("LANGSTAGE_HERMES_DOCKER_WORKSPACE") or os.environ.get("DEEPAGENT_HERMES_DOCKER_WORKSPACE")
