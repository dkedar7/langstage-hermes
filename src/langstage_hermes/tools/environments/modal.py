...
Lazy-imported inside :meth:`init_session` so installing ``langstage-hermes``
...
(https://modal.com/docs/reference/modal.Sandbox):
    ...
    import modal
    app = modal.App.lookup("langstage-hermes", create_if_missing=True)
...
_INSTALL_HINT = "ModalEnvironment requires the 'modal' package. Install with: pip install langstage-hermes[modal]"

_APP_NAME = "langstage-hermes"
    ...
    def init_session(self) -> None:
        ...
        if app_factory is None:
            raise ImportError(
                ...
                "Please file an issue against langstage-hermes with your modal version."
            )
