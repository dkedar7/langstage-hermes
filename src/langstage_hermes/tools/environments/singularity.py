...
def _resolve_workspace() -> Path:
    ...
    """
    override = os.environ.get("LANGSTAGE_HERMES_SINGULARITY_WORKSPACE") or os.environ.get(
        "DEEPAGENT_HERMES_SINGULARITY_WORKSPACE"
    )
    if override:
        path = Path(override)
...
class SingularityEnvironment(BaseEnvironment):
    ...
    def __init__(self, session_id: str) -> None:
        ...
        self._image = os.environ.get("LANGSTAGE_HERMES_SINGULARITY_IMAGE") or os.environ.get(
    ...
    def _snapshot_path(self) -> Path:
        ...
        """
        return self._workspace / f"langstage-hermes-snap-{self.session_id}.sh"

    def _cwd_path(self) -> Path:
        return self._workspace / f"langstage-hermes-cwd-{self.session_id}.txt"
