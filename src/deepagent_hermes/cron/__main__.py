"""Entry point: ``python -m deepagent_hermes.cron``.
...
from deepagent_hermes.cron.jobs import _jobs_file, _output_dir, tick_lock_path
...
def main() -> int:
    ...
    home = hermes_home()
    print(
        "deepagent-hermes cron starting "
    ...
    try:
        ...
        print("\ndeepagent-hermes cron stopping (SIGINT)", flush=True)
        return 0
    except RuntimeError as e:
        print(f"deepagent-hermes cron failed to start: {e}", file=sys.stderr)
        return 2
    return 0
