...
# downstream `langstage-hermes tools` CLI behavior matches user expectations.
...
class HermesToolRegistry:
        ...
        *,
        ...
        Args:
            ...
            toolset: Logical group name (one of the 33 in
                :mod:`langstage_hermes.tools.toolsets`).
    ...
    def invalidate_check_cache(self, tool_name: str | None = None) -> None:
        ...
        ``langstage-hermes tools enable foo``) so the next ``get_tools()``
